...
export const createArticleSchema = z.object({
  ...
  // images simplified (you might want object schema here, but keeping string for now)
  images: z.array(
  z.object({
  ...
  //  Added optional fields to match Article model
...
export const getArticlesSchema = z.object({
  ...
  status: z.enum(['draft', 'published', 'rejected']).optional().default('published'),
});
